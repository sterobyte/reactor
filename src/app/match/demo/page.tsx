  ...
  return (
    ...
    >
      ...
      <div className="mx-auto w-full max-w-7xl px-6 py-6">
        {/* Header */}
        <header
          className="sticky top-0 z-20 border-b mb-6"
          ...
          <div className="py-3 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div
                ...
                aria-hidden
              />
              <h1 className="text-2xl font-semibold tracking-wide">Reactor</h1>
              <span
                className="ml-3 rounded-full px-2.5 py-0.5 text-xs"
                style={{
            ...
            <div className="flex items-center gap-3 text-sm">
              <span className="text-[13px]" style={{ color: "var(--rb-text-dim)" }}>
                Status:
              </span>
              <span
        ...
        <main className="grid grid-cols-12 gap-6">
          ...
          <section className="col-span-12 lg:col-span-8 flex flex-col gap-6">
            ...
            <div
              ...
              style={{ background: "var(--rb-card)", borderColor: "var(--rb-border)" }}
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <MarketCard title="Set 1 Winner">
                <OddsRow name="Player A" odds="1.91" delta={+0.0} />
                <OddsRow name="Player B" odds="1.96" delta={+0.0} />
              </MarketCard>
            ...
            >
              ...
              <div className="flex flex-col gap-2 text-sm">
                {[
                  ...
                  >
                    <span className="text-xs" style={{ color: "var(--rb-text-dim)" }}>
                      {e.t}
                    </span>
  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center justify-between">
        <h4 className="text-sm font-semibold tracking-wide" style={{ color: "var(--rb-text-dim)" }}>
          {title}
        </h4>
        <span
...
function SignalPill({
  ...
  return (
    ...
    >
      <span className="text-[11px] rounded-full px-2 py-0.5" style={{ background: "var(--rb-accent-soft)", color: ring }}>
        {strength}
      </span>
      <span className="text-sm">{market}</span>
      <span className="text-sm font-semibold">{side}</span>
      <span className="text-sm" style={{ color: "var(--rb-text-dim)" }}>
        EV {ev.toFixed(1)}%
      </span>
      <span className="text-xs" style={{ color: "var(--rb-text-dim)" }}>
        TTL {ttl}s
